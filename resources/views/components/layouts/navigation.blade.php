    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links -->
                {{-- <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="/jadwal" :active="request()->routeIs('jadwal')" >
                        {{ __('Jadwal') }}
                    </x-nav-link>
                </div> --}}
               
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="/logbook" :active="request()->routeIs('logbook')" >
                        {{ __('Logbook') }}
                    </x-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="/laporan-jadwal" :active="request()->routeIs('laporan-jadwal')" >
                        {{ __('Laporan Jadwal') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                ...
                {{-- <x-responsive-nav-link href="/jadwal" >
                    {{ __('Jadwal') }}
                </x-responsive-nav-link> --}}
                <x-responsive-nav-link href="/logbook" >
                    {{ __('Logbook') }}
                </x-responsive-nav-link>
